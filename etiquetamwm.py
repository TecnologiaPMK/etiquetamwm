...
def create_label_image(data_fabricacao, part_number, nivel_liberacao, serial_fabricacao, nf, logo_path, 
    ...
    font_data = ImageFont.truetype(font_path, 70)
    font_code = ImageFont.truetype(font_path, 70)
                           
    # Adiciona o logo
    logo = Image.open(logo_path)
    logo = logo.resize((1000, 300)) # altera o tamanho da logo
    img.paste(logo, (100, 300)) # move a logo para esquerda e para baixo 
