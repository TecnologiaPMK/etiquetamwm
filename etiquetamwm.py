...
def create_label_image(data_fabricacao, part_number, nivel_liberacao, serial_fabricacao, nf, logo_path, 
    ...
    font_title = ImageFont.truetype(font_path, 5)
    font_data = ImageFont.truetype(font_path, 5)
    font_code = ImageFont.truetype(font_path, 5)
    ...
    # Código PR
    draw.text((140, 280), PR_datamatrix, fill="black", font=font_code, anchor="mm")
    return img
